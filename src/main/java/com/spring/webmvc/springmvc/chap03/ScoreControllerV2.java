...
//    private final ScoreRepository repository; // 서비스 객체를 활용해서 컨트롤러가 저장소를 의존하지 않게 했기 때문에 지웠다.
    private final ScoreService service;


//    @Autowired
//    public ScoreController(ScoreRepository repository, ScoreService service) { // 빈에 등록된 repository가 ScoreRepositoryImpl 뿐이라서 자동으로 넣어준다.
